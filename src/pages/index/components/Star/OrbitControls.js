...
export const initOrbit = (THREE) => {
	THREE.OrbitControls = function ( object, domElement ) {
		...
		// THREE.global.touchEventHandlerFactory( 'canvas', 'onContextMenu', false );
	
		// THREE.global.touchEventHandlerFactory( 'canvas', 'onPointerDown', false );
		// THREE.global.touchEventHandlerFactory( 'canvas', onMouseWheel, false );
	
		
	
		// THREE.global.touchEventHandlerFactory( 'canvas', onKeyDown, false );
